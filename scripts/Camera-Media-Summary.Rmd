...
# might be better to use a different df as the base for this for future analysis using these variables -- the check event csv doesn't have site ids at the moment though
sites <- days %>% 
  select(site_id) %>%
