...
# mean_event_duration <- events %>%
  ...
  # event duration isn't filled out for these yet, so the function doesn't have any numbers to draw on -- i will address this this week (9/19) when updating MMF
