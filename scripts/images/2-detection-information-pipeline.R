# This script should be run for each camera capture event after a manifest has been created.
# This script adds the trigger event data for each camera capture event to the detection info data file.
...
## fyi some camera capture events were uploaded to Zooniverse with data gaps. We need to retain this data, but update for new. So "v2" should be added to these camera capture events
...
# ^ move this above data load in -- one section of things 
